...
/* VOID:INT,BOOLEAN,CHAR,UCHAR,UINT,LONG,ULONG,ENUM,FLAGS,FLOAT,DOUBLE,STRING,PARAM,BOXED,POINTER,OBJECT,VARIANT,INT64,UINT64 (../subprojects/glib/gobject/tests/marshalers.list:1) */
void
...
/* INT:VOID (../subprojects/glib/gobject/tests/marshalers.list:2) */
void
...
/* UINT:VOID (../subprojects/glib/gobject/tests/marshalers.list:3) */
void
