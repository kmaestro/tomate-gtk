...
void foo_igen_fdpassing_complete_no_annotation (
    FooiGenFDPassing *object,
    GDBusMethodInvocation *invocation,
    GVariant *response,
    const gchar *response_locale);

void foo_igen_fdpassing_complete_no_annotation_nested (
    FooiGenFDPassing *object,
    GDBusMethodInvocation *invocation);
...
void foo_igen_fdpassing_call_no_annotation (
    FooiGenFDPassing *proxy,
    GVariant *arg_greeting,
    const gchar *arg_greeting_locale,
    GCancellable *cancellable,
...
gboolean foo_igen_fdpassing_call_no_annotation_finish (
    FooiGenFDPassing *proxy,
...
gboolean foo_igen_fdpassing_call_no_annotation_sync (
    FooiGenFDPassing *proxy,
    GVariant *arg_greeting,
    const gchar *arg_greeting_locale,
    GVariant **out_response,
...
void foo_igen_fdpassing_call_no_annotation_nested (
    FooiGenFDPassing *proxy,
    GVariant *arg_files,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
...
gboolean foo_igen_fdpassing_call_no_annotation_nested_finish (
    FooiGenFDPassing *proxy,
    GAsyncResult *res,
    GError **error);

gboolean foo_igen_fdpassing_call_no_annotation_nested_sync (
    FooiGenFDPassing *proxy,
    GVariant *arg_files,
    GCancellable *cancellable,
    GError **error);
